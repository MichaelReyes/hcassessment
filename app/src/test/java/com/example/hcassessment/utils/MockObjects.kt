...
fun getCityIdsForException(): List<String> = listOf("12345","23456","345678")

fun getWeatherGroupsResponse(): Maybe<WeatherGroupResponse> = MaybeJust(weatherGroup)
fun getWeatherGroupsExceptionResponse(): Maybe<WeatherGroupResponse> = Maybe.error(Exception("Ids not found"))
