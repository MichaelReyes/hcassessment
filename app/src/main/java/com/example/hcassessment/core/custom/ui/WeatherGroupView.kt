    ...
    init {
        ...
        try{
            if (typedArray.hasValue(R.styleable.WeatherGroupView_wgv_temperature))
                temperature = typedArray.getString(R.styleable.WeatherGroupView_wgv_temperature)
            ...
            if (typedArray.hasValue(R.styleable.WeatherGroupView_wgv_isFavorite))
                isFavorite = typedArray.getBoolean(R.styleable.WeatherGroupView_wgv_isFavorite, false)
